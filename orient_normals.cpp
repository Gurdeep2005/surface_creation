...
{
  const std::string fname = (argc>1) ? argv[1] : CGAL::data_file_path("/home/gurdeep/Desktop/soot_tomography/output/points_with_normals.xyz");
  const std::string output_filename = (argc > 2) ? argv[2] : "/home/gurdeep/Desktop/soot_tomography/output/oriented_normals.xyz";
