...
{
  // Read the input
  const std::string filename = (argc > 1) ? argv[1] : CGAL::data_file_path("/home/gurdeep/Desktop/soot_tomography/output/surface.off");
  ...
  const double relative_offset = (argc > 3) ? std::stod(argv[3]) : 100.;
  ...
  // Save the result
  const std::string output_name = "/home/gurdeep/Desktop/soot_tomography/output/shrink_wrap_2.off";
